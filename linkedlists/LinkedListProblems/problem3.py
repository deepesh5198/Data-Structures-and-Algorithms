#problem 3. find middle element in the list
...
class SLinkedList:
    ...
    def middle_by_traversal(self):
        # this method finds middle element
        # speed O(n)
        # space O(1)
        if self.length == 0:
    ...
    def find_middle_fast(self):
        #this method finds middle element faster
        #speed O(n)
        #space O(1)
